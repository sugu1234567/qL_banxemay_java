...
public class ql_Khachhang extends javax.swing.JFrame {
    ...
    private void GetDataTable() throws SQLException{
        ...
        try {
            ...
            pst = sqlconn.prepareStatement("select * from khachhang order by IDKhachHang,HoTen");
            rs = pst.executeQuery();
    ...
    public ql_Khachhang() throws SQLException {
        initComponents();
        GetDataTable();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "IdKhachHang", "HoTen", "DiaChi", "SDT", "Email", "IDNhanVien"
            }
        ));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(51, 51, 51)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtidkhachhang, javax.swing.GroupLayout.DEFAULT_SIZE, 217, Short.MAX_VALUE)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtIdnhanvien, javax.swing.GroupLayout.Alignment.TRAILING))))
                .addContainerGap())
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        txtidkhachhang.setText(RecordTable.getValueAt(SelectRows, 0).toString());
        ...
        txtIdnhanvien.setText(RecordTable.getValueAt(SelectRows, 5).toString());
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        try {
            sqlconn = DriverManager.getConnection(data, username,pass);
            pst = sqlconn.prepareStatement("update khachhang set HoTen=?, DiaChi=?, SDT=?, Email=?, IDNhanVien=? where (IDKhachHang=?)");
            ...
            pst.setString(6, txtidkhachhang.getText());
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        try {
            sqlconn = DriverManager.getConnection(data,username,pass);
            pst = sqlconn.prepareStatement("insert into khachhang(IDKhachHang,HoTen,DiaChi,SDT,Email,IdNhanVien)value(?,?,?,?,?,?)");

            pst.setString(1,txtidkhachhang.getText());
            pst.setString(2,txtHoten.getText());
            pst.setString(3,txtDiachi.getText());
            pst.setString(4,txtSdt.getText());
            pst.setString(5,txtEmail.getText());
            pst.setString(6,txtIdnhanvien.getText());
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        try {
            sqlconn = DriverManager.getConnection(data, username,pass);
            pst = sqlconn.prepareStatement("delete from khachhang where(IDKhachHang=?)");
            pst.setString(1, txtidkhachhang.getText());
